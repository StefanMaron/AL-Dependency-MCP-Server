...
/**
 * Fallback ZIP extractor using command line unzip for problematic AL packages
 */
export class ZipFallbackExtractor {
  /**
   * Extract SymbolReference.json from AL symbol package using command line unzip
   */
  ...
  /**
   * Run unzip command to extract ZIP file
   */
